...
import com.totato.karaoke.trung.ListenfromAdapterInterface;
...
public class AdapterVideoSelectingOffline extends BaseAdapter {
    ...
    Context context;
    public static ListenfromAdapterInterface listen;

    public static void setListen(ListenfromAdapterInterface listenn) {
        listen = listenn;
    }
